...
- [ ] Le prix est formate au format français (ex : `12,99 EUR`)
- [ ] Le badge affiche "En stock" ou "Rupture" selon `inStock`
- [ ] Le bouton "Ajouter au panier" est désactivé pour les produits en rupture
...
- [ ] L'état du panier est géré dans le composant parent (`ProductList`)

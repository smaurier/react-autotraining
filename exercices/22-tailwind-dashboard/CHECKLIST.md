...
- [ ] Les types `StatCard`, `TaskRow` et `Theme` sont definis dans `src/types/dashboard.ts`
...
- [ ] Le tableau a un hover state sur les lignes et un scroll horizontal sur mobile

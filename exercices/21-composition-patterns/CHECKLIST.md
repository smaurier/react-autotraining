...
- [ ] L'onglet actif est gere par un `useState` interne (mode non controle)
...
- [ ] `tabIndex` est gere correctement (0 pour l'actif, -1 pour les autres)
- [ ] Le composant est headless — aucun style CSS impose
- [ ] Deux instances independantes fonctionnent sur la meme page
